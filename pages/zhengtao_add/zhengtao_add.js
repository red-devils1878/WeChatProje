// pages/zhengtao_add/zhengtao_add.js
var ldmc = ""  //楼栋名称
var mph = ""  //门牌号
var dis = ""
var userid= "";  //登录人的工号
...
Page({
  ...
  formSubmit: function (e){  //保存数据
    ...
    var _data = {ac: 'zhengtao_save',"userid":userid,"fdxm":fdxm,"fddh":fddh,"fdsfz":fdsfz,"sq":sq,"sf":sf,"city":city,"qx":qx,"street":street,"village":village,"fymc":fymc,"dyh":dyh,"mph":mph,"szlc":szlc,"zlc":zlc,"fangxing":fangxing,"cx":cx,"area":area,"rent":rent,"mx_sb":mx_sb,"yg":yg};
    wx.request({
      url: apiUrl,  //api地址
      data: _data,
      header: {'Content-Type': 'application/json'},
