...
Page({
  ...
  formSubmit: function (e){  //保存数据
    ...
    var _data = {ac: 'room_update',"hid":hid,"roomNo":roomNo,"fd":fd,"fangxing":fangxing,"rent":rent,"unit":unit,"area":area,"address":address,"fjzt":fjzt,"cx":cx,"lx":lx,"cz_state":cz_state};
    wx.request({
      url: apiUrl,  //api地址
      data: _data,
      header: {'Content-Type': 'application/json'},
